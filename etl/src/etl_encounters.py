...
from utils import func_rename_and_cast_columns, load_yaml, display_dataset_info, validate_categorical_columns, categorize_column, check_file_exists

def main():
    # Filepaths
    filepath_patients_csv = "../../data/processed_data/processed_patients.csv"
    filepath_csv = "../../data/raw_data/encounters.csv"
    filepath_output = "../../data/processed_data/processed_encounters.csv"
    filepath_yaml = "../../config/encounters.yaml"
    ...
    validate_categorical_columns(df, ["encounter_class", "description", "reason_description"])
